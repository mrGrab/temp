let fs,https,path,fsPromise,api,pkg;_a83‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_a83‍.w("https",[["default",["https"],function(v){https=v}]]);_a83‍.w("path",[["default",["path"],function(v){path=v}]]);_a83‍.w("./util/fsPromise",[["default",["fsPromise"],function(v){fsPromise=v}]]);_a83‍.w("./util/githubApi",[["default",["api"],function(v){api=v}]]);_a83‍.w("../package.json",[["default",["pkg"],function(v){pkg=v}]]);
...
const updateLocal = remoteItem => {
  ...
  return lockFilePromise
    ...
    .then(localFileExists => {
      if (!localFileExists) {
        _a83‍.g.console.log("updating local", filePath);
